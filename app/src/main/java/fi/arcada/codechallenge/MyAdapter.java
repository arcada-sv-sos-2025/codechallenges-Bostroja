...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private final List<fi.arcada.codechallenge.DataModel> dataList;

    // Constructor : initializera adaptern med vår dataList (model)
    public MyAdapter(List<fi.arcada.codechallenge.DataModel> dataList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        fi.arcada.codechallenge.DataModel data = dataList.get(position);
